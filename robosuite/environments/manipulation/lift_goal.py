...
class LiftGoal(SingleArmEnv):
    ...
    def reward(self, action=None):
        ...
        Sparse un-normalized reward:
            ...
            - a discrete reward of 3.25 is provided if the cube is lifted
        ...
        Un-normalized summed components if using reward shaping:
            ...
            - Reaching goal after Lifting: in [0, 1], to encourage to arm to move the cube to goal
    ...
    def _load_model(self):
        ...
        self.goal = BoxObject(
            name="goal",
            size=[self.GOAL_RADIUS, self.GOAL_RADIUS, self.GOAL_RADIUS],
            rgba=(0, 1, 0, 1),
            obj_type="visual",
            joints=None,
        )
        ...
        if self.goal_initializer is not None:
            ...
            # Hardcode randomly sampling z's between 0.1 and 0.2 later in code
    ...
    def _reset_internal(self):
        ...
        if not self.deterministic_reset:
            ...
            # goal_pos = goal_pos[0], goal_pos[1], np.random.uniform(0.1, 0.2)
    ...
    def _check_success(self):
        ...
        goal_height = self.sim.data.body_xpos[self.goal_body_id][2]

        # cube is close to goal height (to avoid bad cases where cube is below goal and still succeeds)
        return cube_height > goal_height - 0.04 and np.linalg.norm(goal_pos - cube_pos) <= self.GOAL_RADIUS
